...
@Component({
  ...
  templateUrl: '../editar-perfil/editar-perfil.component.html',
...
export class EditarPerfilAdminComponent {
  ...
  constructor(
    ...
    this.id_usuario = 0;
    this.foto = '';
    this.usuario = new Administrador(this.id_usuario, this.foto, '', '', '', '', '', '', '', '', '', 0, 0, 0);
    this.tiposUsuario = [];
    this.tiposDocumento = [];
    this.clasesUsuario = [];
  ...
  obtenerUsuario() {
    this._usuarioService.getAdministrador(this.id_usuario).subscribe({
      next: (user) => {
  ...
  guardarUsuario(form: NgForm) {
    ...
    this._usuarioService.updateAdministrador(this.id_usuario, this.usuario).subscribe({
      next: () => {
